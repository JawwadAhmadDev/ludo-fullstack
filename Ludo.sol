...
This is the official contract of the Ludo token. This token
...
contract Ludo is Context, IERC20, Ownable {
    ...
    string private constant _name = "Ludo";
    string private constant _symbol = "OL";
